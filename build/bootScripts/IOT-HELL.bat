...
set JARPATH=%APP_HOME%\lib\IOT-HELL-0.0.1-SNAPSHOT.jar

@rem Execute IOT-HELL
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %IOT_HELL_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%IOT_HELL_EXIT_CONSOLE%" exit 1
exit /b 1
